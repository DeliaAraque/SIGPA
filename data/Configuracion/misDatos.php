		...
		<div class="col-lg-12">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						Correo:
						<input type="text" name="correo" placeholder="Correo electŕonico" value="<?= $usuario->correo; ?>" class="form-control" pattern="^[a-z0-9\-_\.]+@[a-z0-9\-_\.]+\.[a-z0-9\-_\.]+$" required="required" title="Ingrese su correo electrónico" />
					...
					<div class="form-group">
						Teléfono móvil:
						<input type="text" name="telefono" placeholder="Teléfono móvil" value="<?= $usuario->telefono; ?>" class="form-control" pattern="[0-9]{3,4}\-?[0-9]{7}" required="required" />
						<p class="help-block">Ej: 0000-0000000</p>
					</div>

					<div class="form-group">
						Teléfono fijo:
						<input type="text" name="telefonoFijo" placeholder="Teléfono Fijo" value="<?= $usuario->telefonoFijo; ?>" class="form-control" pattern="[0-9]{3,4}\-?[0-9]{7}" />
